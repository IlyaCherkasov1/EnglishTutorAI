...
namespace EnglishTutorAI.Infrastructure.Migrations
{
    ...
    [Migration("20241211093816_RenameDocumentEntityToTranslate")]
    partial class RenameDocumentEntityToTranslate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EnglishTutorAI.Domain.Entities.AchievementLevel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("99645f7f-cefe-4931-8170-81bb0322c667"),
                            AchievementId = new Guid("684f3efb-bf12-42aa-8ff4-17705f81d447"),
                            Goal = 100
                        },
                        new
